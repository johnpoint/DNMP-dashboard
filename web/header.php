...
<header class="mdui-appbar mdui-appbar-fixed">
  <div class="mdui-toolbar mdui-color-theme">
    ...
    <span class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-dialog="{target: \'#dialog-docs-theme\'}" mdui-tooltip="{content: \'夜间模式\'}"><i class="mdui-icon material-icons">color_lens</i></span>
  </div>
  <script>
