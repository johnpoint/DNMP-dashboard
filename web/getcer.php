                ...
                while (($file = readdir($dh)) !== false) {
                    if (is_dir($dir . "/" . $file) && $file != "." && $file != "..") {
                        ...
                        if ($file != "." && $file != ".." && $file != "synccer.sh") {
                            ...
                            echo "&nbsp&nbsp<a href=" . "'https://center.lvcshu.com/editcerfile.php?file=" . $dir . '/' .$myfile . $file ."'". ' class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent">Edit</a>';
                            echo '</div></div>';
                        }
                    }
                }
