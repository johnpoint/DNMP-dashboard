                ...
                while (($file = readdir($dh)) !== false) {
                    if (is_dir($dir."/".$file) && $file!="." && $file!="..") {
                        ...
                        if ($file != "." && $file != ".." && $file != "synccer.sh") {
                            ...
                            echo '<div class="mdui-panel-item-body">';
                            echo '<pre> curl https://center.lvcshu.com/getcerfile.php?secret='.settingsDbEdit('view','secret',NULL,NULL).'&file='.$myfile.$file.' > $file </pre>';
                            echo "<a href=".'\'https://center.lvcshu.com/getcerfile.php?secret='.settingsDbEdit('view','secret',NULL,NULL).'&file='.$myfile.$file."'".'class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent">View</a>';
                            echo '</div></div>';
                        }
                    }
                }
